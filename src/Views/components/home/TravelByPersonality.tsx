...
import { PersonalityCard, type Personality } from "./PersonalityCard";
...
const PERSONALITIES: Personality[] = [
  {
    ...
    priceUsd: 790,
    mainPlace: "Bsharre • Cedars of God • Qadisha Valley",
    days: 4,
    hotelName: "Mountain Lodge (Bsharre)",
  ...
  },
  {
    ...
    priceUsd: 540,
    mainPlace: "Beirut • Mar Mikhael • Hamra",
    days: 3,
    hotelName: "Boutique Hotel (Beirut)",
  ...
  },
  {
    ...
    priceUsd: 620,
    mainPlace: "Baalbek • Anjar • Zahle (Bekaa)",
    days: 3,
    hotelName: "Countryside Stay (Zahle)",
  ...
  },
  {
    ...
    title: "Beirut Nights",
    priceUsd: 590,
    mainPlace: "Beirut • Rooftops • Nightlife districts",
    days: 3,
